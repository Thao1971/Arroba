...
>
> **Verificación conjunta**: `yarn tsc --noEmit` verde · `yarn build` verde · **233/234 unit tests verdes** (el 1 fallo — `r14_comp_id_declaration_guard` sobre `atoms/MethodDetails/SrcDot/Tip`) es **pre-existente**, no tocado por estos tickets).
>
> **Bundle final: 22 unidades** (19 previas + 3 nuevas). No deploy en este job (usuario mantiene control).
>
