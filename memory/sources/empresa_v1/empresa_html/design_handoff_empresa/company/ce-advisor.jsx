...
const DEAL_CTX = {
  venta: 'La compañía tiene un PROCESO DE VENTA / entrada de socio ABIERTO en Arroba (mandato activo). Acciones disponibles para el comprador: descargar NDA, solicitar cuaderno de venta, hacer match con el vendedor.',
  ...
  financiacion: 'La compañía tiene una RONDA DE FINANCIACIÓN ABIERTA para su expansión (equity/deuda). Acciones para el inversor: descargar NDA, solicitar dossier de inversión, hacer match con el inversor.',
  fusion: 'La compañía EXPLORA UNA FUSIÓN con un actor complementario del sector. Acciones: descargar NDA, explorar encaje estratégico, hacer match.',
};
const DEAL_Q = {
